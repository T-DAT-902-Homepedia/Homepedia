...
def aggregate_by_commune(
    biens: DataFrame, seuil_fiabilite: int
) -> DataFrame:
    """Agrège par commune × type_local. Marque (sans supprimer) les communes
    à faible volume via ``fiable``."""
    return (
        biens.groupBy(
